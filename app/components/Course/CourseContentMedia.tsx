  ...
  return (
    <div className="w-[95%] 800px:w-[86%] py-4 m-auto">
      ...
      <div className="w-full p-4 flex items-center justify-between bg-slate-500 bg-opacity-20 backdrop-blur shadow-[bg-slate-700] rounded shadow-inner">
        {["Overview", "Resources", "Q&A", "Reviews", "Test"].map(
          (text, index) => (
            <h5
              key={index}
      ...
      {activeBar === 4 && (
        <div>
          {data[activeVideo]?.testsQuestions.map(
            (questionItem: any, index: number) => (
              <div className="mb-5 border 1px stroke-orange-50 p-3" key={index}>
                <div className="flex justify-between p-2">
                  <h2 className="800px:text-[20px] 800px:inline-block dark:text-white text-black mb-1">
                    {`Question : ${index + 1}  ` + questionItem.question}
                  </h2>
                ...
                {questionItem.options.map(
                  (optionItem: any, optionIndex: number) => (
                    <div className="mb-5" key={optionIndex}>
                      <label className="800px:text-[20px] 800px:inline-block dark:text-white text-black">
                        <input
                          type="radio"
                          ...
                          className="mr-2 custom-radio size-3 bg-red-700 text-red" // Added custom-radio class
                        />
