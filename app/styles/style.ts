export const styles = {
    ...
    labelBig:"text-[20px] font-Poppins text-black dark:text-white ml-[40%] justify-center items-center",
   
      
  // Add styles for navLink and its hover effect
  navLink: "text-black dark:text-white font-Poppins transition-colors duration-300 ease-in-out",

  // Hover effect for navLink
  navLinkHover: "hover:text-[#37a39a]",

    input:"w-full text-black dark:text-white bg-transparent border rounded h-[40px] px-2 outline-none mt-[10px] font-Poppins",
    select:"w-full text-black dark:text-white  border rounded h-[40px] px-2 outline-none mt-[10px] font-Poppins",
